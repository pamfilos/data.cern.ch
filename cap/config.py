...
CACHE_REDIS_DB = 0
#: URL of Redis db.
CACHE_REDIS_URL = "{0}/{1}".format(
    CACHE_REDIS_BASE_URL, CACHE_REDIS_DB)
...
CMS_USER_PRINCIPAL = 'cap@CERN.CH'
CMS_USER_KEYTAB = '/path/to/keytab'
#: CADI database
...
REANA_ATLAS_ACCESS_TOKEN = "CHANGE_ME"
REANA_ALICE_ACCESS_TOKEN = "CHANGE_ME"
REANA_CMS_ACCESS_TOKEN = "CHANGE_ME"
REANA_LHCb_ACCESS_TOKEN = "CHANGE_ME"

# Reana server url
# ================
REANA_ACCESS_TOKEN = {
    'ATLAS': REANA_ATLAS_ACCESS_TOKEN,
    'ALICE': REANA_ALICE_ACCESS_TOKEN,
    'CMS': REANA_CMS_ACCESS_TOKEN,
    'LHCb': REANA_LHCb_ACCESS_TOKEN,
}
